...
export class Seminar extends React.Component {
    ...
    handleCloseCreate = () =>{
        checkclose = false
        this.setState({ utils: { ...this.state.utils, selected: null, showCreate: false, } });
    }
    ...
    handleShowUpdate = (seminar) => {
    console.log(seminar)
    this.setSeminarInState(seminar, { ...this.state.utils, selected: null, showUpdate: true, });}
    ...
    //                    {}
    //                    <h6><Trans i18nKey="seminar.create" /></h6>

    getErrorMsg = () => {
        if (this.props.seminarReducer.error != null && this.props.seminarReducer.error != undefined && this.props.seminarReducer.error.response != undefined && checkclose) {
            return (
                    <div className="alert alert-danger" >
                    <h6 style={{ "margin-bottom": "0" }}><Trans i18nKey="seminar.createrr" /></h6>
                    </div>
            )
        }
    }
    //this.props.seminarReducer.error.response.data.message}
