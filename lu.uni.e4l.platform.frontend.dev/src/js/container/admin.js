...
export class AdminDashboard extends React.Component {
    ...
    render() {
        ...
        if (!this.props.userReducer.user.roles.includes('ADMIN') && !this.props.userReducer.user.roles.includes('WORKSHOP')) {
                ...
                <Container>
                    <Tabs>
                        <TabList>
                            ...
                            {this.props.userReducer.user.roles.includes('ADMIN') && <Tab style={{ margin: "1pt" }}>Users</Tab>}
                            <Tab style={{ margin: "1pt" }}>Questionnaire</Tab>
                            <Tab style={{ margin: "1pt" }}>Static Content</Tab>
                            {(this.props.userReducer.user.roles.includes('ADMIN') || this.props.userReducer.user.roles.includes('WORKSHOP')) && <Tab style={{ margin: "1pt" }}>Mods</Tab>}
                        </TabList>
                        <TabPanel>
                        <Seminar/>
                        </TabPanel>
                        <TabPanel>
                        {this.props.userReducer.user.roles.includes('ADMIN') && <User/>}
                        </TabPanel>
                        {this.props.userReducer.user.roles.includes('ADMIN') && <TabPanel>
                            <h2>Any content 2</h2>
                        </TabPanel>}
                        <TabPanel>
                            <h2>Any content 2</h2>
                        ...
                        <TabPanel>
                        {(this.props.userReducer.user.roles.includes('ADMIN') || this.props.userReducer.user.roles.includes('WORKSHOP')) && <Modes/>}
                        </TabPanel>
                    </Tabs>
                </Container>
