...
export class ResultSeminar extends React.Component {
    ...
    render() {
        ...
        let maxParticipants = seminarResult.resultBreakdownList.length;
        let dtickValue = Math.ceil(maxParticipants / 6);
        return (
            <React.Fragment>
                <div className="container containerE4l">
                    <div className="card ">
                                ...
                                <Plot
                                    ...
                                    data={[
                                        ...
                                        },
                                        {
                                            ...
                                            name: 'Workshop Participants (Amount: ' + seminarResult.resultBreakdownList.length +")",
                                            yaxis: 'y2',
                                            marker: {
                                                color: 'red',
                                            },
