...
export function validateSeminarCode(accessCode) {
    const url = `validate-seminar-code`;
    return {
        type: "VALIDATE_SEMINAR_CODE_REQUEST",
        payload: axios.post(url, { access_code: accessCode })
    }
}
